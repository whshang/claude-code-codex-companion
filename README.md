...
| 功能特性 | CCCC 桌面版 | 传统 Web 版 | 说明 |
|---|---|---|---|
| **用户界面** | ✅ 现代化桌面应用 | ❌ 传统 Web 界面 | React + shadcn/ui |
| **端点管理** | ✅ 图形化配置 | ✅ 表单配置 | 直观的 CRUD 操作 |
| **实时监控** | ✅ 实时仪表板 | ✅ Web 控制台 | 响应式数据展示 |
| **日志查看** | ✅ 结构化日志 | ✅ 日志查看 | 分页、过滤、搜索 |
| **配置管理** | ✅ 在线编辑 | ✅ 配置编辑 | 实时保存验证 |
| **性能统计** | ✅ 可视化图表 | ✅ 统计面板 | 数据图表展示 |
| **部署方式** | ✅ 单文件应用 | ✅ 服务器部署 | 无需 Web 服务器 |
